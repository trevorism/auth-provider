...
class TenantUserServiceTest {
    ...
    void testValidateUser() {
        ...
        assertThrows(AuthException, () -> service.validateRegistration(repository, new RegistrationRequest(username: "tester", password: "TESTer", email: "3.2.1.3.45.21.1.232@gmail.com")))
